...
разброс регулируется `XQUANT_SMART_UP` / `XQUANT_SMART_DN` (по умолчанию `0.30`).

> Следующий шаг: **imatrix** (важность по активациям) — скормить статистику
> активаций с нескольких denoise-шагов и в по-групповой солвер, и в SMART-зонд,
> превратив важность-по-весам в важность-по-активациям (уровень AWQ) — скачок
> качества на 2/3 битах.
